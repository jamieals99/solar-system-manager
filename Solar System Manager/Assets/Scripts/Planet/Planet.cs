...
public class Planet : MonoBehaviour
{
    ...
    public void GenerateMesh()
    {
      //  if (m_PlanetMesh)
        ...
        MeshRenderer surfaceRenderer = m_PlanetMesh.GetComponent<MeshRenderer>();
       ...
       // terrainMesh.colors32 = colors;
        ...
        MeshFilter terrainFilter = m_PlanetMesh.GetComponent<MeshFilter>();
        terrainFilter.mesh = terrainMesh;

       // m_PlanetMesh.transform.localScale = Vector3.one * radius;

        /*Second Scotland

        GameObject planetObject = this.gameObject;
